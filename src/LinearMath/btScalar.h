...
// Urho3D: disable SSE when URHO3D_SSE is disabled, i.e. VS project with "/arch:IA32" compiler flag
#if !defined(_M_IX86_FP) || _M_IX86_FP
...
#define __BT_DISABLE_SSE__
		...
		#else//USE_LIBSPE2
			// Urho3D - allow other systems, including MinGW, Linux, Android, and Apple platforms
			#if !defined (BT_USE_DOUBLE_PRECISION)
				// Urho3D - allow SSE to be disabled when URHO3D_SSE is disabled
				#if defined (__SSE__)
					#define BT_USE_SIMD_VECTOR3
					#define BT_USE_SSE
